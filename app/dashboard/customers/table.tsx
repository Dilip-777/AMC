...
const ActionRendered = ({ row }: { row: Customer }) => {
  const router = useRouter();
  return (
    <div className="flex items-center space-x-3.5">
      <button
        className="hover:text-primary"
        onClick={() => router.push("/dashboard/amc/add")}
      >
        <svg
...
const headCells = [
  ...
  },
  {
    id: "type",
    label: "Customer Type",
    valueGetter: (row: Customer) => row.type,
  },
  {
    id: "address",
    label: "Address",
  ...
  },
  {
    id: "actions",
    label: "Actions",
    actionComponent: (row: Customer) => <ActionRendered row={row} />,
  },
];
