...
const headCells = [
  ...
  { id: "date", label: "Call Date", valueGetter: (row: any) => row.date },
  {
    id: "customer",
    label: "Customer Name",
  ...
  },
  {
    id: "amcCode",
    label: "AMC Code",
    valueGetter: (row: any) => row.amcCode,
  },
  {
    id: "assignedTo",
    label: "Assigned to",
    valueGetter: (row: any) => row.assignedTo,
  },
  {
    id: "status",
    label: "Status",
...
export default function LodgedCallsTable() {
  return (
    <div>
