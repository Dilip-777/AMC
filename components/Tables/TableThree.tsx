...
const headCells = [
  ...
  { id: "name", label: "Name", valueGetter: (row: any) => row.name },
  {
    id: "email",
    label: "Email",
...
const TableThree = (props: Props) => {
  return (
    <div className="rounded-sm border border-strokedark bg-boxdark px-5 pt-6 pb-2.5 shadow-default sm:px-7.5 xl:pb-1">
      <div className="max-w-full overflow-x-auto">
        <table className="w-full table-auto">
          ...
          <tbody>
            {props.tableData?.map((tableItem, key) => (
              <tr key={key}>
                {props.headCells.map((headCell) => (
                  <td
                    key={headCell.id}
